Feature: Reservation
  ...
  Scenario: Reservation de billets
    ...
    Then I click on "ongletBillet"
    Then I uncheck "reservation_billets_0_reduit"
    Then I submit the form "reservation"
    Then I wait for 2 seconds
    ...
    Then I click on "ongletBillet"
    Then I select "journee" from "reservation_billets_0_type"
    Then I fill in "reservation_billets_0_dateNaissance" with "11/06/2015"
    Then I submit the form "reservation"
    Then I wait for 2 seconds
    Then I should see "0 €"
    Then I click on "ongletBillet"
    Then I fill in "reservation_billets_0_dateNaissance" with "11/06/2010"
    Then I submit the form "reservation"
    Then I wait for 2 seconds
    Then I should see "8 €"
    Then I click on "ongletBillet"
    Then I fill in "reservation_billets_0_dateNaissance" with "11/06/1950"
    Then I submit the form "reservation"
    Then I wait for 2 seconds
